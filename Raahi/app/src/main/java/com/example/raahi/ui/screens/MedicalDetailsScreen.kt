...
import com.example.raahi.ui.viewmodels.UserMedicalDetails
...
fun MedicalDetailsContent(
    ...
    Column(
        ...
        MedicalSectionCard(title = "Known Medical Conditions", items = medicalDetails.knownMedicalConditions)
        MedicalSectionCard(title = "Allergies", items = medicalDetails.allergies)
        
        MedicalSectionCard(title = "Emergency Medical Contact") {
            DetailRow(label = "Name", value = medicalDetails.emergencyMedicalContactName)
            DetailRow(label = "Number", value = medicalDetails.emergencyMedicalContactNumber)
        }

        MedicalSectionCard(title = "Travel Insurance") {
            DetailRow(label = "Provider", value = medicalDetails.travelInsuranceProvider)
            DetailRow(label = "Policy Number", value = medicalDetails.travelInsurancePolicyNumber)
        }
